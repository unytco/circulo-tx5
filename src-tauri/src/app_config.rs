...
pub const IDENTIFIER_DIR: &'static str = "co.unyt.tx5.circulo";
pub const APP_ID_PREFIX: &'static str = "circulo-tx5";
...
impl AppConfig {
    pub fn new<R: tauri::Runtime>(handle: &AppHandle<R>) -> Self {
        ...
        Self {
            ...
            network_seed: format!("{}-{}-add11", handle.config().identifier, version),
        }
    }
}
